...
6. ⚠️ [Backend Required](#required)

## <a name="welcome"> 👋 Welcome </a>

Thanks for checking out this sportz app. This app is the frontend part of a complete full stack web socket application with an [Sportz Backend](https://github.com/Miki0035/sportz-websocket) backend. This app is from one of JavaScript Mastery Youtube
...
## <a name="required">⚠️ Backend Required</a>
